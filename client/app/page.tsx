...
import { CheckCircle, Clock, Users, BarChart3, Briefcase, Award, BookOpen, Target, Shield, Star, MapPin } from "lucide-react"
...
export const metadata: Metadata = {
  title: "Transform Your Insurance Career in 4 Hours | N S Anilkumar Workshop - May 18th 2025",
  description: "Join N S Anilkumar's exclusive workshop at Hotel Dimora, Trivandrum to learn proven strategies to 2X your insurance client base. Early bird price ₹5,999 only. 34+ years experience, 1 Lakh+ professionals trained.",
  keywords: "insurance workshop, insurance career growth, insurance sales training, N S Anilkumar, insurance business growth, Trivandrum workshop",
  openGraph: {
    title: "Transform Your Insurance Career in 4 Hours | N S Anilkumar Workshop",
    description: "Join us on May 18th 2025 at Hotel Dimora, Trivandrum. Early bird price ₹5,999 only. Learn proven strategies to 2X your insurance client base. 34+ years experience, 1 Lakh+ professionals trained.",
    images: [
      {
        url: "/og-image.jpg",
        width: 1200,
  ...
  twitter: {
    ...
    title: "Transform Your Insurance Career | N S Anilkumar Workshop - May 18th 2025",
    description: "Join us at Hotel Dimora, Trivandrum. Early bird price ₹5,999 only. Learn proven strategies to 2X your insurance client base. 34+ years experience.",
    images: ["/og-image.jpg"],
  },
  robots: {
    index: true,
  ...
  return (
    <main className="min-h-screen bg-white pb-32">
      ...
      <section className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100">
        ...
        <div className="lg:hidden px-4 pt-4 pb-20">
          <div className="container mx-auto max-w-md">
            ...
            <div className="bg-[#fff0ed] rounded-full px-3 py-1.5 mb-4 flex items-center justify-center gap-2 animate-pulse">
              <div className="w-2 h-2 bg-[#e85d3d] rounded-full"></div>
              <p className="text-[#e85d3d] text-sm font-medium">
            ...
            <div className="text-center space-y-3 mb-6">
              <Badge className="bg-[#e85d3d] text-white px-4 py-1.5 text-sm font-medium uppercase tracking-wide">
                Exclusive Live Workshop
              </Badge>
              <h1 className="text-2xl sm:text-3xl font-bold text-slate-900 leading-tight">
                Transform Your <span className="text-[#e85d3d] relative inline-block">
                  Insurance Career
                  <span className="absolute bottom-0 left-0 right-0 h-1 bg-[#e85d3d]/30 rounded-full"></span>
                </span> in Just 4 Hours
              </h1>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-5 mb-6">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 rounded-full overflow-hidden border-2 border-[#fff0ed]">
                    <Image
                      src="/hero.png"
                      alt="N S Anilkumar"
                      width={48}
                  ...
                  <div>
                    ...
                    <p className="text-[#e85d3d] font-semibold text-xs uppercase">Insurance & Sales Expert</p>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-3 gap-2">
                <div className="bg-slate-50 p-2 rounded-lg text-center">
                  <p className="text-lg font-bold text-[#e85d3d]">1 Lakh+</p>
                  <p className="text-xs text-slate-600">Trained</p>
                </div>
                <div className="bg-slate-50 p-2 rounded-lg text-center">
                  <p className="text-lg font-bold text-[#e85d3d]">1000+</p>
                  <p className="text-xs text-slate-600">Workshops</p>
                </div>
                <div className="bg-slate-50 p-2 rounded-lg text-center">
                  <p className="text-lg font-bold text-[#e85d3d]">4.96/5</p>
            ...
            <div className="space-y-4 mb-6">
              <div className="bg-gradient-to-r from-[#fff0ed] to-[#fff0ed]/50 rounded-2xl p-4">
                <div className="flex items-center justify-between mb-2">
                  <Badge variant="outline" className="bg-white text-[#e85d3d] border-[#ffcec2] text-xs">Limited Time</Badge>
                  <Badge variant="outline" className="bg-white text-[#e85d3d] border-[#ffcec2] text-xs">Early Bird Offer</Badge>
                </div>
                <div className="flex items-baseline gap-2">
                  <span className="text-3xl font-bold text-[#e85d3d]">₹5,999</span>
                  <span className="text-[#e85d3d] line-through text-sm">₹9,999</span>
              ...
              <div className="flex items-center gap-2 bg-slate-50 p-3 rounded-xl border border-slate-200">
                ...
                <div className="text-xs text-slate-800">
                  <p className="font-semibold">May 18th 2025 | 10:00 AM - 2:00 PM</p>
              ...
              <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm">
                ...
                <div className="mb-4">
                  <div className="flex items-start gap-3 p-3 bg-[#fff0ed] rounded-lg border border-[#ffcec2]">
                    <div className="w-6 h-6 rounded-full bg-[#e85d3d] flex items-center justify-center flex-shrink-0 mt-0.5">
                      <CheckCircle className="h-4 w-4 text-white" />
                    </div>
                    <div>
                      <p className="font-semibold text-slate-800 text-sm">More Profit, More Freedom, More Scale</p>
                      <p className="text-slate-600 text-xs">Is Guaranteed If You Follow The Exact Steps Covered In The Workshop</p>
                    </div>
                  </div>
                </div>
                
                <div className="text-center mb-3">
                  <h3 className="font-bold text-slate-800 text-lg">STARTS ON May 18th 2025</h3>
                  <p className="text-slate-600 text-sm">(10:00 AM - 2:00 PM) at Hotel Dimora, Trivandrum</p>
                </div>
            ...
            <div className="space-y-4 mb-8">
              ...
              <Button size="lg" className="w-full bg-[#e85d3d] hover:bg-[#d94c2c] text-white py-4 text-base font-semibold rounded-xl shadow-md hover:shadow-lg transition-all duration-300 transform hover:translate-y-[-2px] animate-button-pulse">
              ...
              <div className="w-1/2 pt-8">
                <div className="text-left space-y-8">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-3">
                      <div className="flex items-center gap-2 bg-[#fff0ed] px-3 py-1.5 rounded-full animate-pulse">
                        <span className="w-2 h-2 bg-[#e85d3d] rounded-full"></span>
                        <p className="text-[#e85d3d] font-medium text-sm">47 People Watching Live</p>
                      </div>
                      <Badge className="bg-[#fff0ed] text-[#e85d3d] border-[#ffcec2]">
                        40% OFF
                      </Badge>
                    </div>
                    <Badge className="bg-[#e85d3d] hover:bg-[#d94c2c] text-white px-6 py-2 uppercase tracking-wide font-semibold">
                      Exclusive Live Workshop
                    </Badge>
                  </div>
                  ...
                  <div className="bg-white rounded-xl shadow-lg p-6 border border-slate-100 hover:shadow-xl transition-all duration-300">
                    <div className="flex items-center justify-between mb-6">
                      <div className="flex items-center gap-4">
                        <div className="w-16 h-16 rounded-full overflow-hidden border-2 border-[#fff0ed]">
                          <Image
                            src="/hero.png"
                            alt="N S Anilkumar"
                            width={64}
                        ...
                        <div>
                          ...
                          <p className="text-[#e85d3d] font-semibold text-sm uppercase">Insurance & Sales Expert</p>
                        </div>
                      </div>
                      <div className="text-right">
                    ...
                    <div className="grid grid-cols-3 gap-4">
                      <div className="bg-slate-50 p-4 rounded-lg text-center transform hover:scale-105 transition-transform shadow-sm hover:shadow-md">
                        <p className="text-2xl font-bold text-[#e85d3d]">10K+</p>
                        <p className="text-sm text-slate-600">Professionals Trained</p>
                      </div>
                      <div className="bg-slate-50 p-4 rounded-lg text-center transform hover:scale-105 transition-transform shadow-sm hover:shadow-md">
                        <p className="text-2xl font-bold text-[#e85d3d]">1000+</p>
                        <p className="text-sm text-slate-600">Workshops Conducted</p>
                      </div>
                      <div className="bg-slate-50 p-4 rounded-lg text-center transform hover:scale-105 transition-transform shadow-sm hover:shadow-md">
                        <p className="text-2xl font-bold text-[#e85d3d]">4.96/5</p>
                  ...
                  <div className="space-y-6">
                    <div className="flex items-stretch gap-4">
                      <div className="flex-1 bg-gradient-to-br from-[#fff0ed] to-[#fff0ed]/50 p-6 rounded-xl border border-[#ffcec2] transform hover:scale-105 transition-transform shadow-sm hover:shadow-md">
                        <div className="flex items-center justify-between mb-2">
                          <p className="text-[#e85d3d] text-sm uppercase font-bold tracking-wider">Early Bird Offer</p>
                          <Badge variant="outline" className="text-[#e85d3d] border-[#ffcec2]">Limited Seats</Badge>
                        </div>
                        <div className="flex items-baseline gap-2">
                          <span className="text-4xl font-extrabold text-[#e85d3d]">₹5,999</span>
                          <span className="text-[#e85d3d] line-through font-medium">₹9,999</span>
                          <span className="text-[#e85d3d] text-sm">only</span>
                        </div>
                        <div className="mt-2 text-sm text-[#e85d3d]">
                          <p className="flex items-center gap-1"><Clock className="h-4 w-4" /> May 18th 2025 | 10:00 AM - 2:00 PM</p>
                          <p className="flex items-center gap-1 mt-1"><MapPin className="h-4 w-4" /> Hotel Dimora, Trivandrum</p>
                      </div>
                      </div>
                      <div className="flex-1 bg-gradient-to-br from-emerald-50 to-emerald-100/50 p-6 rounded-xl border border-emerald-200 transform hover:scale-105 transition-transform shadow-sm hover:shadow-md">
                    ...
                    <div className="space-y-4">
                      <div className="relative">
                        ...
                        <Button size="lg" className="w-full bg-[#e85d3d] hover:bg-[#d94c2c] text-lg px-8 py-6 shadow-lg hover:shadow-xl transition-all duration-300 rounded-xl font-semibold group animate-button-pulse transform hover:translate-y-[-2px]">
                          <div className="flex flex-col items-center">
                            <span className="tracking-wide group-hover:scale-105 transition-transform">Register Now at ₹5,999 Only</span>
                            <span className="text-sm opacity-90 font-medium">Only 14 Seats Left!</span>
                          </div>
                        </Button>
                      </div>
                      <p className="text-center text-sm text-slate-500">
                        Join thousands of top-performing insurance experts transforming their business
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="w-1/2 relative">
                <div className="sticky top-0 pt-4">
                      ...
                      <div className="absolute -bottom-4 left-0 right-0 bg-white px-5 py-3 rounded-xl shadow-lg border border-slate-100 text-center transform hover:scale-105 transition-all duration-300">
                        <div className="flex items-center justify-center gap-2">
                          ...
                          <p className="text-base md:text-lg font-semibold text-slate-800">
                            Trusted by <span className="text-[#e85d3d]">1 Lakh+</span> Insurance Professionals
                          </p>
                  ...
                  {/* Countdown Timer Under Image */}
                    ...
                    <div className="mb-6">
                      <div className="flex items-start gap-3 p-3 bg-[#fff0ed] rounded-lg border border-[#ffcec2]">
                        <div className="w-7 h-7 rounded-full bg-[#e85d3d] flex items-center justify-center flex-shrink-0 mt-0.5">
                          <CheckCircle className="h-5 w-5 text-white" />
                        </div>
                        <div>
                          <p className="font-semibold text-slate-800">More Profit, More Freedom, More Scale</p>
                          <p className="text-slate-600 text-sm">Is Guaranteed If You Follow The Exact Steps Covered In The Workshop</p>
                        </div>
                      </div>
                    </div>
                    
                    <div className="text-center mb-4">
                      <h3 className="font-bold text-slate-800 text-xl mb-1">STARTS ON May 18th 2025</h3>
                      <p className="text-slate-600">(10:00 AM - 2:00 PM) at Hotel Dimora, Trivandrum</p>
                    </div>
                    ...
                    <div className="text-center">
                      <Button size="lg" className="bg-[#e85d3d] hover:bg-[#d94c2c] text-lg px-6 py-3 shadow-lg hover:shadow-xl transition-all duration-300 rounded-full font-semibold shadow-md hover:shadow-lg transition-all duration-300 transform hover:translate-y-[-2px] animate-button-pulse">
                        Register Now at ₹5,999 Only
                      </Button>
                    </div>
                  </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <Card className="bg-slate-50 hover:bg-slate-100 transition-colors duration-300">
                  <CardContent className="pt-6">
                    <div className="text-center">
                      <p className="text-4xl font-bold text-[#e85d3d] mb-2">1 Lakh+</p>
                ...
                <Card className="bg-slate-50 hover:bg-slate-100 transition-colors duration-300">
                  <CardContent className="pt-6">
                    <div className="text-center">
                      <p className="text-4xl font-bold text-[#e85d3d] mb-2">1000+</p>
              ...
              <div className="mt-8 grid grid-cols-2 md:grid-cols-4 gap-4">
                {[
                  ...
                  <div key={index} className="text-center p-4 bg-slate-50 rounded-lg">
                    <p className="text-xl font-bold text-[#e85d3d]">{stat.label}</p>
      ...
      <section className="py-20 bg-slate-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-bold text-slate-900 mb-4">What You Will Learn In 4 Hrs?</h2>
            ...
            <div className="w-full lg:w-3/5 space-y-6">
              <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100 hover:shadow-md transition-shadow duration-300">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-slate-900 mb-1">7 Foundational Activities Used By Successful Insurance Professionals</h3>
                    <p className="text-slate-600">Which You Can COPY To Build A Stable And Scalable Insurance Business.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100 hover:shadow-md transition-shadow duration-300">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-slate-900 mb-1">3 Ingredients You Need To Focus On</h3>
                    <p className="text-slate-600">To Build An Insurance Business That Can Grow Without You.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100 hover:shadow-md transition-shadow duration-300">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-slate-900 mb-1">How To Build Your Front-Line Leaders:</h3>
                    <p className="text-slate-600">Understand The Step-By-Step Process Of Building Your Second Line Of Insurance Leaders That You Can Implement Immediately</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100 hover:shadow-md transition-shadow duration-300">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-slate-900 mb-1">How To Retain Insurance Employees:</h3>
                    <p className="text-slate-600">Strategies And Systems That You Can Implement To Make Sure You Create An Environment For Employees To Work Longer So That You Can Focus On Strategic Business Growth.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white p-5 rounded-xl shadow border-l-4 border-[#e85d3d]">
                <p className="text-slate-800 font-semibold text-center">
                  Strategies Are Applicable To ALL Types Of Insurance Businesses, <br /> Regardless Of Industry Or Team Size
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <Badge className="bg-[#fff0ed] text-[#e85d3d] mb-4 px-4 py-1">Psychology of Insurance Success</Badge>
            <h2 className="text-3xl md:text-4xl font-bold mb-6 text-slate-900">The Transformation You'll Experience</h2>
            <p className="text-slate-600 text-lg max-w-3xl mx-auto">
              Learn powerful strategies already implemented by 10,000+ top insurance professionals across India
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white rounded-xl p-6 border border-slate-100 shadow-sm hover:shadow-md transition-all duration-300 transform hover:scale-105">
              ...
              <div className="text-center">
                <h3 className="text-xl font-bold text-slate-900 mb-3">Time Freedom</h3>
                <p className="text-slate-600">
                  Build systems to process more insurance applications with less effort, giving you back precious hours in your day.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 border border-slate-100 shadow-sm hover:shadow-md transition-all duration-300 transform hover:scale-105">
              ...
              <div className="text-center">
                <h3 className="text-xl font-bold text-slate-900 mb-3">Client Acquisition</h3>
                <p className="text-slate-600">
                  Learn proven strategies to attract high-premium clients who stay longer and refer more business to you.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 border border-slate-100 shadow-sm hover:shadow-md transition-all duration-300 transform hover:scale-105">
              ...
              <div className="text-center">
                <h3 className="text-xl font-bold text-slate-900 mb-3">Premium Growth</h3>
                <p className="text-slate-600">
                  Implement systems to consistently grow your premium income even during industry downturns and market fluctuations.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 border border-slate-100 shadow-sm hover:shadow-md transition-all duration-300 transform hover:scale-105">
              ...
              <div className="text-center">
                <h3 className="text-xl font-bold text-slate-900 mb-3">Team Expansion</h3>
                <p className="text-slate-600">
                  Develop and retain a team of motivated insurance advisors who will help multiply your agency's impact and revenue.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-gradient-to-br from-slate-50 to-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <Badge className="bg-[#fff0ed] text-[#e85d3d] mb-4 px-4 py-1">Insurance Growth Strategies</Badge>
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-slate-900">Transform Your Insurance Business With These Proven Tactics</h2>
            <p className="text-slate-600 text-lg max-w-3xl mx-auto">
              These techniques have helped over 1,000+ insurance agents increase their policies and premium collection
            </p>
          </div>
          <div className="max-w-4xl mx-auto">
              ...
              {[
                {
                  ...
                  description: "Copy these 7 daily activities that top 1% insurance agents use to consistently close high-value policies"
                },
                {
                  title: "Build a Self-Running Insurance Agency",
                  description: "Discover the exact framework to create an insurance business that generates premiums without your constant involvement"
                },
                {
                  title: "Insurance Team Leadership Blueprint",
                  description: "Step-by-step method to identify and train future insurance leaders who will help scale your agency"
                },
                {
                  title: "Insurance Advisor Retention Mastery",
                  description: "Proven techniques to keep your top insurance performers engaged, motivated and loyal for years"
                },
                {
                  title: "Policy Renewal & Referral Automation",
                  description: "Install systems that bring qualified insurance prospects to you on autopilot through existing clients"
                },
                {
                  title: "Insurance Productivity Maximization",
                  description: "How to process more applications and service more clients in less time through delegation and automation"
                }
              ].map((item, index) => (
                <div key={index} className="flex items-start gap-4 p-5 bg-white rounded-xl shadow-sm border border-slate-100 hover:shadow-md transition-all duration-300 transform hover:translate-x-1">
            ...
            <div className="bg-[#fff0ed] border border-[#ffcec2] rounded-xl p-6 mb-8">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="text-xl font-bold text-[#ff9d85]">Limited Time Offer</h3>
              </div>
              <p className="text-[#e85d3d] mb-4">
                This workshop is specifically designed for insurance professionals who are serious about scaling their business. The strategies work for agencies of all sizes.
              </p>
              <div className="flex items-center justify-between">
                <div className="flex items-baseline gap-2">
                  <span className="text-2xl font-bold text-[#ff9d85]">₹5,999</span>
                  <span className="text-[#e85d3d] line-through">₹9,999</span>
                </div>
                <Badge variant="outline" className="bg-[#fff0ed] text-[#e85d3d] border-[#ffcec2]">
                  40% Off
                </Badge>
              </div>
            </div>
      ...
      <section className="py-16 bg-slate-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <Badge className="bg-[#fff0ed] text-[#e85d3d] mb-4">Perfect For You If...</Badge>
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-slate-900">Who Will Benefit The Most</h2>
            <p className="text-slate-600 text-lg max-w-3xl mx-auto">
              Join the community of insurance professionals who are taking their insurance career to the next level
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto mb-12">
            <div className="bg-white rounded-xl shadow-sm overflow-hidden group hover:shadow-md transition-all duration-300">
              ...
              <div className="p-6">
                ...
                <h3 className="text-xl font-bold text-center text-slate-900 mb-3">LIC Agents</h3>
                <p className="text-center text-slate-600">
                  Looking to increase your policy sales and premium collection while working fewer hours per policy
                </p>
            ...
            <div className="bg-white rounded-xl shadow-sm overflow-hidden group hover:shadow-md transition-all duration-300">
              ...
              <div className="p-6">
                ...
                <h3 className="text-xl font-bold text-center text-slate-900 mb-3">Insurance Agency Owners</h3>
                <p className="text-center text-slate-600">
                  Wanting to build systems and teams for your insurance agency that can operate successfully without your daily involvement
                </p>
                <div className="mt-4 text-center">
                  <Badge variant="outline" className="bg-[#fff0ed] text-[#e85d3d] border-[#ffcec2]">
                    95% Success Rate
            ...
            <div className="bg-white rounded-xl shadow-sm overflow-hidden group hover:shadow-md transition-all duration-300">
              ...
              <div className="p-6">
                ...
                <h3 className="text-xl font-bold text-center text-slate-900 mb-3">POSP/Development Officers</h3>
                <p className="text-center text-slate-600">
                  Seeking strategies to recruit, train and retain high-performing insurance agents in your organization
                </p>
                <div className="mt-4 text-center">
                  <Badge variant="outline" className="bg-[#fff0ed] text-[#e85d3d] border-[#ffcec2]">
                    97% Success Rate
            ...
            <div className="bg-white rounded-xl shadow-sm overflow-hidden group hover:shadow-md transition-all duration-300">
              ...
              <div className="p-6">
                ...
                <h3 className="text-xl font-bold text-center text-slate-900 mb-3">Insurance Sales Managers</h3>
                <p className="text-center text-slate-600">
                  Aiming to implement proven systems to consistently hit and exceed policy sales targets with your team
                </p>
                <div className="mt-4 text-center">
                  <Badge variant="outline" className="bg-[#fff0ed] text-[#e85d3d] border-[#ffcec2]">
                    91% Success Rate
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-white p-8 rounded-xl shadow border-l-4 border-[#e85d3d]">
              <div className="flex flex-col md:flex-row items-center gap-6">
                ...
                <div>
                  <h3 className="text-xl font-bold text-slate-900 mb-2">Join the Elite Insurance Community</h3>
                  <p className="text-slate-700 mb-4">
                    Over 10,000+ insurance professionals across India have already implemented these strategies with remarkable success. The methods work for all insurance companies, products, and experience levels.
                  </p>
                  <div className="flex flex-wrap gap-2">
                    <Badge className="bg-[#fff0ed] text-[#e85d3d]">LIC</Badge>
                    <Badge className="bg-[#fff0ed] text-[#e85d3d]">HDFC Life</Badge>
                    <Badge className="bg-[#fff0ed] text-[#e85d3d]">ICICI Prudential</Badge>
                    <Badge className="bg-[#fff0ed] text-[#e85d3d]">SBI Life</Badge>
                    <Badge className="bg-[#fff0ed] text-[#e85d3d]">Max Life</Badge>
                    <Badge className="bg-[#fff0ed] text-[#e85d3d]">Bajaj Allianz</Badge>
                    <Badge className="bg-[#fff0ed] text-[#e85d3d]">Star Health</Badge>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="text-center mt-12">
            <Button size="lg" className="w-full max-w-md mx-auto bg-[#e85d3d] hover:bg-[#d94c2c] text-white text-base md:text-lg px-4 py-3 md:py-4 rounded-full font-semibold shadow-lg hover:shadow-xl transition-all duration-300 relative overflow-hidden group">
              <span className="relative z-10">Register Now at ₹5,999 Only</span>
              <div className="absolute inset-0 bg-gradient-to-r from-[#e85d3d] to-[#ff7d5d] opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              <div className="absolute inset-0 opacity-0 group-hover:opacity-70 transition-opacity duration-700 bg-[#e85d3d] blur-xl"></div>
            </Button>
            ...
            <Card className="bg-emerald-50 border-emerald-200">
              <CardContent className="pt-6">
                <p className="text-slate-800 mb-4">
                  If after attending the session you feel it didn't deliver the value you were hoping for—for any reason at all—I take complete responsibility. Simply send an email to nsanilkumar.bridge@gmail.com, and my team will refund your entire session fee of ₹5,999—no questions asked.
                </p>
      ...
      <section className="py-16 sm:py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-8 sm:mb-12">
            <Badge className="bg-[#fff0ed] text-[#e85d3d] mb-4 px-3 sm:px-4 py-1">Transformation Journey</Badge>
            ...
            <p className="text-slate-600 text-base sm:text-lg max-w-3xl mx-auto mt-6">
              Comprehensive programs designed to transform your financial mindset and insurance career
            </p>
          </div>
              ...
              <div className="p-4 sm:p-6">
                <div className="flex justify-between items-start mb-4">
                  <div className="w-12 h-12 sm:w-14 sm:h-14 bg-amber-100 rounded-full flex items-center justify-center transform group-hover:scale-110 transition-transform duration-300">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 sm:h-8 sm:w-8 text-amber-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                  </div>
                  <Badge className="bg-amber-100 text-amber-700 hover:bg-amber-200 shadow-sm text-xs">Foundation Level</Badge>
                </div>
                
                <h3 className="text-lg sm:text-xl font-bold text-slate-900 mb-3 group-hover:text-amber-700 transition-colors duration-300">MONEY MINDSET MASTERY</h3>
                
                <ul className="space-y-2 mb-6 text-sm sm:text-base">
                  <li className="flex items-start gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#e85d3d] flex-shrink-0 mt-0.5" viewBox="0 0 20 20" fill="currentColor">
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span className="text-slate-700">Savings & Investment Methods</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#e85d3d] flex-shrink-0 mt-0.5" viewBox="0 0 20 20" fill="currentColor">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                    </svg>
                    <span className="text-slate-700">Guidance to Create 1Cr-10Cr Wealth</span>
                  </li>
                </ul>
                
                <Button variant="outline" className="w-full border-amber-300 text-amber-700 hover:bg-amber-50 py-2 sm:py-2.5 font-medium transition-all duration-300 hover:border-amber-400 shadow-sm group-hover:bg-amber-100">
                  Learn More
                </Button>
              </div>
            </div>
              ...
              <div className="p-4 sm:p-6">
                <div className="flex justify-between items-start mb-4">
                  <div className="w-12 h-12 sm:w-14 sm:h-14 bg-emerald-100 rounded-full flex items-center justify-center transform group-hover:scale-110 transition-transform duration-300">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 sm:h-8 sm:w-8 text-emerald-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
                    </svg>
                  </div>
                  <Badge className="bg-emerald-100 text-emerald-700 hover:bg-emerald-200 shadow-sm text-xs">Growth Level</Badge>
                </div>
                
                <h3 className="text-lg sm:text-xl font-bold text-slate-900 mb-3 group-hover:text-emerald-700 transition-colors duration-300">WEALTH EXPANSION BLUEPRINT</h3>
                ...
                <ul className="space-y-2 mb-6 text-sm sm:text-base">
                  <li className="flex items-start gap-2">
                    ...
                    <span className="text-slate-700">Practical Knowledge of Wealth Creation</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#e85d3d] flex-shrink-0 mt-0.5" viewBox="0 0 20 20" fill="currentColor">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                    </svg>
                    <span className="text-slate-700">Different Ways to Create Wealth</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#e85d3d] flex-shrink-0 mt-0.5" viewBox="0 0 20 20" fill="currentColor">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                    </svg>
                    <span className="text-slate-700">Savings and Investment Support</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#e85d3d] flex-shrink-0 mt-0.5" viewBox="0 0 20 20" fill="currentColor">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                ...
                <Button variant="outline" className="w-full border-emerald-300 text-emerald-700 hover:bg-emerald-50 py-2 sm:py-2.5 font-medium transition-all duration-300 hover:border-emerald-400 shadow-sm group-hover:bg-emerald-100">
                  Learn More
                </Button>
              </div>
            </div>
              ...
              <div className="p-4 sm:p-6">
                <div className="flex justify-between items-start mb-4">
                  <div className="w-12 h-12 sm:w-14 sm:h-14 bg-blue-100 rounded-full flex items-center justify-center transform group-hover:scale-110 transition-transform duration-300">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 sm:h-8 sm:w-8 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                  </div>
                  <Badge className="bg-blue-100 text-blue-700 hover:bg-blue-200 shadow-sm text-xs">Advanced Level</Badge>
                </div>
                
                <h3 className="text-lg sm:text-xl font-bold text-slate-900 mb-3 group-hover:text-blue-700 transition-colors duration-300">FINANCIAL FREEDOM ACCELERATOR</h3>
                ...
                <ul className="space-y-2 mb-6 text-sm sm:text-base">
                  <li className="flex items-start gap-2">
                    ...
                    <span className="text-slate-700">How to Keep Your Wealth</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#e85d3d] flex-shrink-0 mt-0.5" viewBox="0 0 20 20" fill="currentColor">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                    </svg>
                    <span className="text-slate-700">Passive Income Strategies</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#e85d3d] flex-shrink-0 mt-0.5" viewBox="0 0 20 20" fill="currentColor">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                    </svg>
                    <span className="text-slate-700">Business Growth Systems</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#e85d3d] flex-shrink-0 mt-0.5" viewBox="0 0 20 20" fill="currentColor">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                    </svg>
                    <span className="text-slate-700">Work-Life Balance Mastery</span>
                  </li>
                </ul>
                
                <Button variant="outline" className="w-full border-blue-300 text-blue-700 hover:bg-blue-50 py-2 sm:py-2.5 font-medium transition-all duration-300 hover:border-blue-400 shadow-sm group-hover:bg-blue-100">
                  Learn More
                </Button>
              </div>
            </div>
              ...
              <div className="p-4 sm:p-6">
                <div className="flex justify-between items-start mb-4">
                  <div className="w-12 h-12 sm:w-14 sm:h-14 bg-purple-100 rounded-full flex items-center justify-center transform group-hover:scale-110 transition-transform duration-300">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 sm:h-8 sm:w-8 text-purple-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                    </svg>
                  </div>
                  <Badge className="bg-purple-100 text-purple-700 hover:bg-purple-200 shadow-sm text-xs">Elite Level</Badge>
                </div>
                
                <h3 className="text-lg sm:text-xl font-bold text-slate-900 mb-3 group-hover:text-purple-700 transition-colors duration-300">LEGACY & WEALTH MASTERY</h3>
                ...
                <ul className="space-y-2 mb-6 text-sm sm:text-base">
                  <li className="flex items-start gap-2">
                    ...
                    <span className="text-slate-700">Multi-Generational Wealth Planning</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#e85d3d] flex-shrink-0 mt-0.5" viewBox="0 0 20 20" fill="currentColor">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                    </svg>
                    <span className="text-slate-700">Estate Planning Strategies</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#e85d3d] flex-shrink-0 mt-0.5" viewBox="0 0 20 20" fill="currentColor">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                    </svg>
                    <span className="text-slate-700">Advanced Wealth Protection</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#e85d3d] flex-shrink-0 mt-0.5" viewBox="0 0 20 20" fill="currentColor">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                    </svg>
                    <span className="text-slate-700">Philanthropic Giving Strategies</span>
                  </li>
                </ul>
                
                <Button variant="outline" className="w-full border-purple-300 text-purple-700 hover:bg-purple-50 py-2 sm:py-2.5 font-medium transition-all duration-300 hover:border-purple-400 shadow-sm group-hover:bg-purple-100">
                  Learn More
                </Button>
              </div>
            </div>
          ...
          <div className="mt-12 text-center">
            <p className="text-slate-700 mb-6 text-base sm:text-lg">
              Each course builds upon the previous level to create a complete wealth transformation system
            </p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white rounded-xl p-6 text-center shadow-sm hover:shadow-md transition-all duration-300 border border-slate-100 transform hover:translate-y-[-5px] group">
                <div className="w-14 h-14 bg-[#fff0ed] rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-[#e85d3d]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path>
                  </svg>
                </div>
                <h3 className="text-lg font-bold text-slate-900 mb-2 group-hover:text-[#e85d3d] transition-colors duration-300">Call Us</h3>
                <a href="tel:+919876543210" className="text-[#e85d3d] font-medium hover:underline">
                  +91 98765 43210
                </a>
              ...
              <div className="bg-white rounded-xl p-6 text-center shadow-sm hover:shadow-md transition-all duration-300 border border-slate-100 transform hover:translate-y-[-5px] group">
                ...
                <h3 className="text-lg font-bold text-slate-900 mb-2 group-hover:text-[#e85d3d] transition-colors duration-300">Email Us</h3>
                <a href="mailto:nsanilkumar.bridge@gmail.com" className="text-[#e85d3d] font-medium hover:underline">
                  nsanilkumar.bridge@gmail.com
                </a>
                <p className="text-sm text-slate-500 mt-2">
                  We respond to all emails<br />
                  within 24 hours
                </p>
              </div>
              ...
              <div className="bg-white rounded-xl p-6 text-center shadow-sm hover:shadow-md transition-all duration-300 border border-slate-100 transform hover:translate-y-[-5px] group">
                ...
                <h3 className="text-lg font-bold text-slate-900 mb-2 group-hover:text-[#e85d3d] transition-colors duration-300">Visit Us</h3>
                <p className="text-[#e85d3d] font-medium">
                  Hotel Dimora, Trivandrum
                </p>
                <p className="text-sm text-slate-500 mt-2">
                  Workshop Venue<br />
                  May 18th 2025, 10 AM - 2 PM
                </p>
              </div>
              
              <div className="mt-10 text-center">
                <p className="text-slate-700 mb-4">Join our WhatsApp community for updates</p>
